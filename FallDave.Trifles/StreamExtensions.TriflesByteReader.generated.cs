...
namespace FallDave.Trifles
{
    public static partial class StreamExtensions
    {
        ...
        /// </exception>
        public static void ReadFully(this ITriflesByteReader source, byte[] buffer, int offset, int count)
        {
        ...
        public static IEnumerable<int> ReadViaArray(this ITriflesByteReader source, byte[] buffer)
        {
        ...
        /// <exception cref="ArgumentException"><paramref name="buffer"/> is 0-length.</exception>
        public static void ReadViaArray(this ITriflesByteReader source, Action<byte[], int, int> fillAction, byte[] buffer = null)
        {
        ...
        /// </exception>
        public static IEnumerable<int> ReadViaArray(this ITriflesByteReader source, int maxCount, byte[] buffer, bool requireFullCount = false)
        {
        ...
        /// while <paramref name="requireFullCount"/> is <c>true</c>. (Thrown from enumeration.)
        /// </exception>
        public static void ReadViaArray(this ITriflesByteReader source, int maxCount, Action<byte[], int, int> fillAction, byte[] buffer = null, bool requireFullCount = false)
        {
        ...
        /// while <paramref name="requireFullCount"/> is <c>true</c>. (Thrown from enumeration.)
        /// </exception>
        public static IEnumerable<int> ReadViaArray(this ITriflesByteReader source, long maxCount, byte[] buffer, bool requireFullCount = false)
        {
            return TriflesByteReaderImpl.ReadViaArray(source.ToTriflesByteReader(), maxCount, buffer, requireFullCount);
        }
        ...
        /// while <paramref name="requireFullCount"/> is <c>true</c>. (Thrown from enumeration.)
        /// </exception>
        public static void ReadViaArray(this ITriflesByteReader source, long maxCount, Action<byte[], int, int> fillAction, byte[] buffer = null, bool requireFullCount = false)
        {
            TriflesByteReaderImpl.ReadViaArray(source.ToTriflesByteReader(), maxCount, fillAction, buffer, requireFullCount);
        }
        ...
        /// while <paramref name="requireFullCount"/> is <c>true</c>. (Thrown from enumeration.)
        /// </exception>
        public static IEnumerable<int> ReadViaArray(this ITriflesByteReader source, ulong maxCount, byte[] buffer, bool requireFullCount = false)
        {
            return TriflesByteReaderImpl.ReadViaArray(source.ToTriflesByteReader(), maxCount, buffer, requireFullCount);
        }
        ...
        /// while <paramref name="requireFullCount"/> is <c>true</c>. (Thrown from enumeration.)
        /// </exception>
        public static void ReadViaArray(this ITriflesByteReader source, ulong maxCount, Action<byte[], int, int> fillAction, byte[] buffer = null, bool requireFullCount = false)
        {
            TriflesByteReaderImpl.ReadViaArray(source.ToTriflesByteReader(), maxCount, fillAction, buffer, requireFullCount);
        }
        ...
        /// while <paramref name="requireFullCount"/> is <c>true</c>. (Thrown from enumeration.)
        /// </exception>
        public static void ReadViaArray(this Stream source, int maxCount, Action<byte[], int, int> fillAction, byte[] buffer = null, bool requireFullCount = false)
        {
            TriflesByteReaderImpl.ReadViaArray(source.ToTriflesByteReader(), maxCount, fillAction, buffer, requireFullCount);
        }
        ...
        /// while <paramref name="requireFullCount"/> is <c>true</c>. (Thrown from enumeration.)
        /// </exception>
        public static void ReadViaArray(this Stream source, long maxCount, Action<byte[], int, int> fillAction, byte[] buffer = null, bool requireFullCount = false)
        {
            TriflesByteReaderImpl.ReadViaArray(source.ToTriflesByteReader(), maxCount, fillAction, buffer, requireFullCount);
        }
        ...
        /// while <paramref name="requireFullCount"/> is <c>true</c>. (Thrown from enumeration.)
        /// </exception>
        public static void ReadViaArray(this Stream source, ulong maxCount, Action<byte[], int, int> fillAction, byte[] buffer = null, bool requireFullCount = false)
        {
            TriflesByteReaderImpl.ReadViaArray(source.ToTriflesByteReader(), maxCount, fillAction, buffer, requireFullCount);
        }
        ...
        /// The end of the stream was reached before the read could be fully completed.
        /// </exception>
        public static void ReadFully(this BinaryReader source, byte[] buffer, int offset, int count)
        {
            TriflesByteReaderImpl.ReadFully(source.ToTriflesByteReader(), buffer, offset, count);
        }
        ...
        /// while <paramref name="requireFullCount"/> is <c>true</c>. (Thrown from enumeration.)
        /// </exception>
        public static void ReadViaArray(this BinaryReader source, int maxCount, Action<byte[], int, int> fillAction, byte[] buffer = null, bool requireFullCount = false)
        {
            TriflesByteReaderImpl.ReadViaArray(source.ToTriflesByteReader(), maxCount, fillAction, buffer, requireFullCount);
        }
        ...
        /// while <paramref name="requireFullCount"/> is <c>true</c>. (Thrown from enumeration.)
        /// </exception>
        public static void ReadViaArray(this BinaryReader source, long maxCount, Action<byte[], int, int> fillAction, byte[] buffer = null, bool requireFullCount = false)
        {
            TriflesByteReaderImpl.ReadViaArray(source.ToTriflesByteReader(), maxCount, fillAction, buffer, requireFullCount);
        }
        ...
        /// while <paramref name="requireFullCount"/> is <c>true</c>. (Thrown from enumeration.)
        /// </exception>
        public static void ReadViaArray(this BinaryReader source, ulong maxCount, Action<byte[], int, int> fillAction, byte[] buffer = null, bool requireFullCount = false)
        {
            TriflesByteReaderImpl.ReadViaArray(source.ToTriflesByteReader(), maxCount, fillAction, buffer, requireFullCount);
        }
